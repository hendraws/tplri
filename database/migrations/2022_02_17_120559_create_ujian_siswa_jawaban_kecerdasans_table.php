...
class CreateUjianSiswaJawabanKecerdasansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ujian_siswa_jawaban_kecerdasans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ujian_siswa_jawaban_kecerdasans');
    }
}
