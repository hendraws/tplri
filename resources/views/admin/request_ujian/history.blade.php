                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        Menunggu Verifikasi
                                        @elseif($item->status_akses == 1)
                                        Di ijinkan

                                        @elseIf($item->status_akses == 2)
                                        Di Tolak
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        <a href="Javascript:void(0)" class="btn btn-xs btn-success ubah"
                                            data-url="{{ action('UjianSiswaController@approvalUjian', $item->id) }}"
                                            data-status="1" data-name="di Ijinkan">Ubah Status</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
