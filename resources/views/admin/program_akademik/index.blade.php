					...
					$.ajax({
						...
						success:function(data) {
							if (data.code == '200'){
                                ...
                                setTimeout(function(){ window.location = "{{ action('ProgramAkademikController@index') }}"; }, 1500);
...
<a class="btn btn-sm btn-primary modal-button ml-2 float-right" href="Javascript:void(0)"  data-target="ModalForm" data-url="{{ action('ProgramAkademikController@create') }}"  data-toggle="tooltip" data-placement="top" title="Tambah" >Tambah Program Akademik</a>
