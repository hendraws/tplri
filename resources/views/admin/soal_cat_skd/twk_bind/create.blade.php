...
@section('title', 'Tambah Soal TWK  - Bahasa Indonesia')
@section('css')
...
@section('content')
    <div class="card card-accent-primary border-primary shadow-sm table-responsive">
        <form method="POST" action="{{ action('SoalCatSkdController@storeTwkBind') }}" enctype='multipart/form-data'>
            @csrf
            <div class="card-body">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="kategori" value="bind">
