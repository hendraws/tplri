...
@section('title', 'Kepribadian Sesi 2')
@section('css')
...
@section('button-title')
    <a class="btn btn-sm btn-primary  ml-2 float-right" href="{{ action('KepribadianController@create_sesi2') }}"
        data-toggle="tooltip" data-placement="top" title="Tambah">Tambah
        Soal Kepribadian Sesi 2</a>
