<div class="row mt-5" id="content-soal">
    <ol>
        ...
        <div {{ !$loop->first ? 'style=display:none;' : '' }} id="list-{{ $loop->index + 1 }}" class="list-soal">
                            ...
                            <td style="width: 20%">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio"
                                        ...
                                        value="{{ $pilihanGanda->id }}" data-jb="{{ $dataSoal->jawaban_id }}" >
                                    <label class="form-check-label" for="pilihan-{{ $pilihanGanda->id }}">
            ...
            <div class="col-md-12" >
                <a href="javascript:void(0)" class="btn btn-primary simpan" data-ujian="{{ $ujian->id }}" data-soal="{{ $dataSoal->id }}" data-urutan="{{ $loop->index + 1 }}"  data-jb="{{ $dataSoal->jawaban_id }}">Simpan</a>
