...
<head>
    ...
    <title>CAT AKADEMIK | UJIAN MATEMATIKA</title>
...
<body>
    <div class="container-fluid" style="min-height:100vh;">
        <div class="row p-3" style="background: #e43205;">
            ...
            <div class="col-md-2 align-self-center text-center">
                ...
                <form action="{{ action('AkademikUjianSiswaController@storeJawaban') }}" id="selesaiUjianForm"
                    method="POST">
                    @csrf
                    <input type="hidden" name="ujianSiswaId" value="{{ $ujianSiswa->id }}">
                    <input type="hidden" name="ujian_mapel" value="{{ $mapel }}">
        ...
        <div class="row">
            ...
            <div class="col-md-9 border bagianBody">
                    <div class="row">
                        <div class="col-12">
                            @include('ujian.akademik.pilihan-jawaban')
                        </div>
                    </div>
                <form action="{{ action('AkademikUjianSiswaController@storeJawaban') }}" id="formStoreUjian">
                    @csrf
    ...
    <script src="{{ asset('js/ujian_cat_akademik.js') }}"></script>
