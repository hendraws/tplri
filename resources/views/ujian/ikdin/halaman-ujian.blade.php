...
<body>
    <div class="container-fluid" style="min-height:100vh;">
        <div class="row p-3" style="background: #e43205;">
            ...
            <div class="col-md-2 align-self-center text-center">
                ...
                <form action="{{ action('IkdinUjianSiswaController@storeJawaban') }}" id="selesaiUjianForm"
                    method="POST">
                    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-9 border bagianBody">
                    <div class="row">
                        <div class="col-12">
                            @include('ujian.ikdin.pilihan-jawaban')
                        </div>
                    </div>
                <form action="{{ action('IkdinUjianSiswaController@storeJawaban') }}" id="formStoreUjian">
                    @csrf
    ...
    <script src="{{ asset('js/ujian_cat_ikdin.js') }}"></script>
