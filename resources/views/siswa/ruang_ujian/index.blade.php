...
<body class="hold-transition login-page" style="background-color: #FFEAAD;">
    <div class="container ">
        <h1 class="text-center">CAT Kepribadian Polri Rumah Private Kino</h1>

        @if ($ujianSiswa->kepribadian == 0)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            of the card's content.</p> --}}
                                ...
                                @elseif($ujianSiswa->kepribadian == 1)
                                    <button class="btn btn-secondary col-12 mt-4" type="button" disabled>Test Belum Tersedia</button>
                                @endif
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h5>Nilai CAT Kepribadian</h5>
                            <h1 class="border text-center p-3">
                                {{ floor(optional($ujianSiswa->getNilai)->kepribadian) }}
                            </h1>

                            <h4 class="border text-center p-3">
                                @if (floor(optional($ujianSiswa->getNilai)->kepribadian) >= 61)
                                    Memenuhi Syarat
                                @else
