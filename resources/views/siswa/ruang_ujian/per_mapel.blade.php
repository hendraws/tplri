                        ...
                        <div class="card-body ">
                            <form method="POST" action="{{ action('AkademikUjianSiswaController@halamanUjian') }}">
                                ...
                                @elseIf($ujianSiswa->mtk == 1)
                                    <button type='button' class="btn btn-success col-12 mt-4">NILAI UJIAN  MATEMATIKA
                        ...
                        <div class="card-body ">
                            <form method="POST" action="{{ action('AkademikUjianSiswaController@halamanUjian') }}">
                                ...
                                @elseIf($ujianSiswa->wk == 1)
                                     <button type='button' class="btn btn-success col-12 mt-4">NILAI UJIAN WAWASAN
                                        KEBANGSAAN
                        ...
                        <div class="card-body ">
                            <form method="POST" action="{{ action('AkademikUjianSiswaController@halamanUjian') }}">
                                ...
                                @elseIf($ujianSiswa->pu == 1)
                                     <button type='button' class="btn btn-success col-12 mt-4">NILAI UJIAN PENGETAHUAN
                                        UMUM
                            ...
                            <div class="card-body ">
                                <form method="POST" action="{{ action('AkademikUjianSiswaController@halamanUjian') }}">
                                    ...
                                    @elseIf($ujianSiswa->bahasa == 1)
                                         <button type='button' class="btn btn-success col-12 mt-4">NILAI UJIAN BAHASA
                                            INGGRIS
